...
class ScrollableCommandList:
    ...
    def draw(self):
        '''Renders the command list on the screen at (self.x, self.y). '''
        pygame.draw.rect(self.screen, self.bgColor, (self.x, self.y, self.width, self.height)) #Draw background container of list
